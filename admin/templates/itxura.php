		...
		<div class="span12">
			<div class="user-zone">
				...
				<span class="user-zone-right">
					...
					Logged in: <i class="icon-user"></i> <a href="<?php echo URL_BASE; ?>administrazioa/form?edit_id=<?php echo $erabiltzailea->get_id (); ?>"> <?php echo $erabiltzailea->get_erabiltzailea (); ?></a>
				</span>
