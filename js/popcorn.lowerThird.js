...
(function ( Popcorn) {
	Popcorn.plugin( "lowerThird", {
		manifest: {
			about:{
				name: "Popcorn lowerThird Plugin iametza",
				version: "0.2",
				author: "bbginnovate, iametza interaktiboa",
		...
		start: function(event, options){
			...
			if ( transitionContainer ) {
				...
				var linkStr="<div id='lowerThirdLinkDiv'><a class='lowerThirdLink' href='"+linkUrl+"' target='_blank'>"+linkTitle+"</a></div>";
				
				var imgStyle="";
				var imgDivStr="";
				if (options.includeLogo) {
					if (options.logo) {
						imgStyle=" style=\"background-image:url(" + options.logo + ")\" ";
